    ...
    <div id='testimonial' className='bg-[#f7f8fc] py-12'>
      <div className="container mx-auto pb-20">
        <div className='text-center mb-12'>
          <h2 className='text-4xl font-bold font-secondary mb-3 pt-12'>What Our Clients Say</h2>
        ...
        <div className='flex flex-col md:w-4/5 mx-auto md:flex-row md:gap-12 gap-8 pl-8 pr-8 md:pl-0'>
            {testimonials.map((testimonial, index) => (
              <div key={index} className='relative bg-white rounded-lg p-6 flex-1'>
                ...
                <div className='flex gap-1'>
                  <img src={testimonial.image} alt="testimonial image" className='size-16 rounded-full object-cover mr-4' />
                  <div>
