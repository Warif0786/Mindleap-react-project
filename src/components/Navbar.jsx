...
const Navbar = () => {
  ...
  const navLinks = (
    <ul className="flex flex-col md:flex-row font-medium lg:space-x-8 sm:space-x-4 space-y-2 md:space-y-0 p-4 md:p-0">
      <li>
        <motion.a
          href="#home"
  ...
  return (
    <header className="bg-heroBg text-white py-6 px-4 fixed top-0 left-0 right-0 z-10">
      ...
      {
        isOpen && (
            <nav className="absolute top-full left-0 w-full text-white bg-heroBg md:hidden z-20">
