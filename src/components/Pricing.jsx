...
const packages = [
  {
    name: 'Bronze Package',
    price: "$99",
    description: "Ideal for individuals or small businesses looking to get started witn mental wellness.",
    features: [
    ...
    <div id='pricing' className='bg-[#f7f8fc] pt-32'>
      <div className="container mx-auto px-8">
        <div className='text-center mb-12'>
          ...
          <p className='text-lg mb-12 md:w-2/3 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, accusantium voluptas ipsam temporibus tenetur voluptatibus magnam nulla id, libero nisi at numquam, nostrum doloremque non?</p>
        </div>
        ...
        <div className='flex flex-col md:w-5/6 mx-auto md:flex-row gap-8 pb-12'>
            {
              packages.map((pkg, index) => (
                <div key={index} className='bg-white rounded-lg p-6 flex-1 shadow-lg'>
                  ...
                  className='bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded'>Get Started</button>
                </div>
              ))
            }
        </div>
